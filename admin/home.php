...
$priseEnChargeListe = $db->query('select p.id, p.libelle as priseEnCharge, prix, mo.libelle as modele from prise_en_charge p join modele_appareil mo on mo.id = p.modele_ref;')->fetchAll(PDO::FETCH_ASSOC);

// var_dump($priseEnChargeListe);

$reparations = $db->query('select re.id, re.total, mo.libelle as modele, re.prise_en_charge as object from reparations re join modele_appareil mo on mo.id = re.modele_id order by re.id desc ;')->fetchAll(PDO::FETCH_ASSOC);
            ...
            <header>
                ...
                <a href="./type_appareil.php" class="redirect">
                    <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 48 48">
                        <path d="M12.905,20.0328H9.0934L4.5,27.9889H8.3116Z" />
                        <path d="M28.1821,9.0236V19.8082H24.3705l-4.5934,7.9561h8.405V38.9764L43.5,23.8437Z" />
                        <path d="M20.4316,20.0328H16.62l-4.5934,7.9561h3.8116Z" />
                    </svg>
                </a>
            </header>
            ...
            <header>
                ...
                <a href="./marque_appareil.php" class="redirect">
                    <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 48 48">
                        ...
                        <path class="a" d="M12.905,20.0328H9.0934L4.5,27.9889H8.3116Z" />
                        <path class="a"
                            d="M28.1821,9.0236V19.8082H24.3705l-4.5934,7.9561h8.405V38.9764L43.5,23.8437Z" />
                        <path class="a" d="M20.4316,20.0328H16.62l-4.5934,7.9561h3.8116Z" />
                    </svg>
                </a>
            </header>
