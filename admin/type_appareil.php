...
<head>
    ...
    <link rel="stylesheet" href="../assets/admin/css/type_appareil.css">
...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li class='actif'><a href="./type_appareil.php">Type d'appareil</a></li>
    ...
    <div class="container">
                        ...
                        <tr>
                            ...
                            <td><?= $l['libelle'] ?>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24"
                                        ...
                                        onclick="deleteElement(this,'<?= $l['libelle'] ?>' )">
                                        <path
        ...
        <div class="add">
            <form action="../php/admin/addType.php" method="POST">
...
<script>
    const URL = "../php/admin/deleteType.php"
</script>
</html>