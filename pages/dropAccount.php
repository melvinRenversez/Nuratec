...
<h3>Vous n'etes pas a l'origine de cette demande faite le <?php echo formater_date($result['created_at']); ?> </h3>
<!-- <h3>Vous avez voulu creer un compte sur notre site <?php echo formater_date($result['created_at']); ?></h3> -->

<h4>Voici les informations entrees :</h4>
...
<form action="../php/dropAccount.php" method="POST">
